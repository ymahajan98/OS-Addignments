...
static pthread_mutex_t bit_map_inode;
static pthread_mutex_t bit_map_data;
static pthread_mutex_t cache_array;
static pthread_mutex_t dirty_cache;
                ...
                if(!strcmp(cnt->key,key)){
                    ...
                    for(int l=0;l<4;l++){
                        if(cnt->indirect[l]!=0){
                           ...
                           #ifdef CACHE
                               read_cached(objfs,cnt->indirect[l]-WRITE_OFFSET,(char *)tem);
                           #else
